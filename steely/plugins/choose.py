...
def main(bot, author_id, message, thread_id, thread_type, *args, **kwargs):
    try:
        ...
        bot.sendMessage(random.choice(args), thread_id=thread_id, thread_type=thread_type)
    except IndexError:
        bot.sendMessage(random.choice(ERRORS), thread_id=thread_id, thread_type=thread_type)